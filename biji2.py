...
options = {
    'proxy': {
        'http': 'http://1dbaa052cf65bb3db213__cr.bg:6dc234a7f64de12d@gw.dataimpulse.com:10102',
        'https': 'https://1dbaa052cf65bb3db213__cr.bg:6dc234a7f64de12d@gw.dataimpulse.com:10102',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/68fa1942-7fd3-4141-a2de-be86172e3085")
time.sleep(50000)
