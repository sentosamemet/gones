...
options = {
    'proxy': {
        'http': 'http://1dbaa052cf65bb3db213__cr.ar:6dc234a7f64de12d@gw.dataimpulse.com:10011',
        'https': 'https://1dbaa052cf65bb3db213__cr.ar:6dc234a7f64de12d@gw.dataimpulse.com:10011',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/8c0bda46-4157-49c0-95f4-75bc957b303d")
time.sleep(50000)
