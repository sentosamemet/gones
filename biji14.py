...
options = {
    'proxy': {
        'http': 'http://1dbaa052cf65bb3db213__cr.ar:6dc234a7f64de12d@gw.dataimpulse.com:10114',
        'https': 'https://1dbaa052cf65bb3db213__cr.ar:6dc234a7f64de12d@gw.dataimpulse.com:10114',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/f452bab6-eda6-4b1b-99e9-319258b15c8b")
time.sleep(50000)
